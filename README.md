...
SQL is a language that lets us querey relational dbs. 

- [ ] Why do tables need a `primary key`?
To ID each row/data set within a table; needed for linking to other tables. 
...
Intermediary table that ties togeth the ids from the two other tables. 
